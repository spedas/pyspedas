...
def mms_fpi_set_metadata(probe, data_rate, level, suffix=''):
    """
    ...
    for this_probe in probe:
        for this_dr in data_rate:
            for this_lvl in level:
                options('mms'+this_probe+'_dis_energyspectr_par_'+this_dr+suffix, 'ytitle', 'MMS'+this_probe+' DIS (eV)')
                options('mms'+this_probe+'_dis_energyspectr_anti_'+this_dr+suffix, 'ytitle', 'MMS'+this_probe+' DIS (eV)')
                options('mms'+this_probe+'_dis_energyspectr_perp_'+this_dr+suffix, 'ytitle', 'MMS'+this_probe+' DIS (eV)')
                ...
                options('mms'+this_probe+'_dis_energyspectr_par_'+this_dr+suffix, 'ylog', True)
                options('mms'+this_probe+'_dis_energyspectr_par_'+this_dr+suffix, 'zlog', True)
                options('mms'+this_probe+'_dis_energyspectr_par_'+this_dr+suffix, 'Colormap', 'jet')
                
                options('mms'+this_probe+'_dis_energyspectr_anti_'+this_dr+suffix, 'ylog', True)
                options('mms'+this_probe+'_dis_energyspectr_anti_'+this_dr+suffix, 'zlog', True)
                options('mms'+this_probe+'_dis_energyspectr_anti_'+this_dr+suffix, 'Colormap', 'jet')
                
                options('mms'+this_probe+'_dis_energyspectr_perp_'+this_dr+suffix, 'ylog', True)
                options('mms'+this_probe+'_dis_energyspectr_perp_'+this_dr+suffix, 'zlog', True)
                options('mms'+this_probe+'_dis_energyspectr_perp_'+this_dr+suffix, 'Colormap', 'jet')
                ...
                options('mms'+this_probe+'_dis_energyspectr_par_'+this_dr+suffix, 'ztitle', '[keV/(cm^2 s sr keV)]')
                options('mms'+this_probe+'_dis_energyspectr_anti_'+this_dr+suffix, 'ztitle', '[keV/(cm^2 s sr keV)]')
                options('mms'+this_probe+'_dis_energyspectr_perp_'+this_dr+suffix, 'ztitle', '[keV/(cm^2 s sr keV)]')
