...
if os.environ.get('VIRES_TOKEN'):
    ...
    try:
        ...
        logging.warning('Unable to load VIRES access token from VIRES_TOKEN environment variable or token file %s.',
                        token_file)
        logging.warning(
            'Visit https://viresclient.readthedocs.io/en/latest/access_token.html to set up an account and generate an access token.')
    except configparser.NoSectionError:
        logging.warning('Unable to load VIRES access token from VIRES_TOKEN environment variable or token file %s.', token_file)
        logging.warning('Visit https://viresclient.readthedocs.io/en/latest/access_token.html to set up an account and generate an access token.')
