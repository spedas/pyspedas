...
def magephem(trange=['2018-11-5', '2018-11-6'], 
    ...
    """
    return load(instrument='magephem', trange=trange, probe=probe, cadence=cadence, coord=coord, suffix=suffix, get_support_data=get_support_data, varformat=varformat, varnames=varnames, downloadonly=downloadonly, notplot=notplot, time_clip=time_clip, no_update=no_update)
