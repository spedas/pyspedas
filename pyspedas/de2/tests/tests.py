...
class LoadTestCases(unittest.TestCase):
    ...
    def test_load_vefi_data(self):
        del_data()
        out_vars = pyspedas.de2.vefi(trange=["1981-12-06", "1981-12-07"])
    ...
    def test_load_lang_data(self):
        del_data()
        out_vars = pyspedas.de2.lang(time_clip=True)
