...
from pytplot import data_exists, get_data, store_data, cdf_to_tplot, del_data
...
class LunCotransDataValidation(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.tha_state_pos_sel_sse = get_data('tha_state_pos_sel_sse')
        ...
        cls.tha_state_vel_gse_sel_sse = get_data('tha_state_vel_gse_sel_sse')
    ...
    def test_gse2sse_vel_rotate_only(self):
        ...
        self.assertEqual(result,1)
        pos_sse = get_data('tha_state_vel_sse_rotate_only')
