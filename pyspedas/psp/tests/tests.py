...
class LoadTestCases(unittest.TestCase):
    ...
    def test_load_fld_data_prefix_none(self):
        fields_vars = pyspedas.psp.fields(trange=['2018-11-5', '2018-11-5/06:00'], datatype='mag_rtn', level='l2', time_clip=True, prefix=None)
        self.assertTrue(data_exists('psp_fld_l2_mag_RTN'))

    def test_load_fld_data_suffix_none(self):
        fields_vars = pyspedas.psp.fields(trange=['2018-11-5', '2018-11-5/06:00'], datatype='mag_rtn', level='l2', time_clip=True, suffix=None)
        self.assertTrue(data_exists('psp_fld_l2_mag_RTN'))

    def test_load_fld_data_prefix_suffix(self):
        fields_vars = pyspedas.psp.fields(trange=['2018-11-5', '2018-11-5/06:00'], datatype='mag_rtn', level='l2', time_clip=True, prefix='pre_', suffix='_suf')
    ...
    def test_load_spc_data_prefix_none(self):
        spc_vars = pyspedas.psp.spc(trange=['2018-11-5', '2018-11-6'], datatype='l3i', level='l3', prefix=None)
        self.assertTrue(data_exists('psp_spc_np_fit'))

    def test_load_spc_data_suffix_none(self):
        spc_vars = pyspedas.psp.spc(trange=['2018-11-5', '2018-11-6'], datatype='l3i', level='l3', suffix=None)
        self.assertTrue(data_exists('psp_spc_np_fit'))
    
    def test_load_spc_data_suffix_none(self):
        spc_vars = pyspedas.psp.spc(trange=['2018-11-5', '2018-11-6'], datatype='l3i', level='l3', prefix='pre_', suffix='_suf')
    ...
    def test_load_spe_data_prefix_none(self):
        spe_vars = pyspedas.psp.spe(trange=['2018-11-5', '2018-11-6'], datatype='spa_sf1_32e', level='l2', prefix=None)
        self.assertTrue(data_exists('psp_spe_EFLUX'))
    
    def test_load_spe_data_suffix_none(self):
        spe_vars = pyspedas.psp.spe(trange=['2018-11-5', '2018-11-6'], datatype='spa_sf1_32e', level='l2', suffix=None)
        self.assertTrue(data_exists('psp_spe_EFLUX'))
    
    def test_load_spe_data_prefix_suffix(self):
        spe_vars = pyspedas.psp.spe(trange=['2018-11-5', '2018-11-6'], datatype='spa_sf1_32e', level='l2', prefix='pre_', suffix='_suf')
    ...
    def test_load_spi_data_prefix_none(self):
        spi_vars = pyspedas.psp.spi(trange=['2018-11-5', '2018-11-6'], datatype='spi_sf0a_mom_inst', level='l3', prefix=None)
        self.assertTrue(data_exists('psp_spi_DENS'))
    
    def test_load_spi_data_suffix_none(self):
        spi_vars = pyspedas.psp.spi(trange=['2018-11-5', '2018-11-6'], datatype='spi_sf0a_mom_inst', level='l3', suffix=None)
        self.assertTrue(data_exists('psp_spi_DENS'))
    
    def test_load_spi_data_prefix_suffix(self):
        spi_vars = pyspedas.psp.spi(trange=['2018-11-5', '2018-11-6'], datatype='spi_sf0a_mom_inst', level='l3', prefix='pre_', suffix='_suf')
    ...
    def test_load_epihi_data_prefix_none(self):
        epihi_vars = pyspedas.psp.epihi(trange=['2018-11-5', '2018-11-5/06:00'], datatype='let1_rates1h', level='l2', prefix=None)
        self.assertTrue(data_exists('psp_epihi_B_He_Rate'))
    
    def test_load_epihi_data_suffix_none(self):
        epihi_vars = pyspedas.psp.epihi(trange=['2018-11-5', '2018-11-5/06:00'], datatype='let1_rates1h', level='l2', suffix=None)
        self.assertTrue(data_exists('psp_epihi_B_He_Rate'))

    def test_load_epihi_data_prefix_suffix(self):
        epihi_vars = pyspedas.psp.epihi(trange=['2018-11-5', '2018-11-5/06:00'], datatype='let1_rates1h', level='l2', prefix='pre_', suffix='_suf')
    ...
    def test_load_epi_data_prefix_none(self):
        epilo_vars = pyspedas.psp.epi(prefix=None)
        self.assertTrue(data_exists('psp_isois_HET_A_Electrons_Rate_TS'))

    def test_load_epi_data_suffix_none(self):
        epilo_vars = pyspedas.psp.epi(suffix=None)
        self.assertTrue(data_exists('psp_isois_HET_A_Electrons_Rate_TS'))

    def test_load_epi_data_prefix_suffix(self):
        epilo_vars = pyspedas.psp.epi(prefix='pre_', suffix='_suf')
