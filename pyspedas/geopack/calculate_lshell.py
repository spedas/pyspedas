...
def calculate_lshell(pos_tvar: str, newname: str, units_in:str = None, coord_in:str = None):
    """
    ...
    ttrace2endpoint(pos_tvar,'igrf', 'equator', units_in=units_in, coord_in=coord_in, foot_name='eq_foot', trace_name='eq_trace')
