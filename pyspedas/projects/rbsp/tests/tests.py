...
class LoadTestCases(unittest.TestCase):
    ...
    def test_load_rbspice_esrhelt_prefix_none(self):
        del_data('*')
        rbspice_vars = pyspedas.rbsp.rbspice(trange=['2013-11-5', '2013-11-6'], datatype='ESRHELT', level='l3', prefix=None)
        self.assertTrue(data_exists('rbspa_rbspice_l3_ESRHELT_FEDU'))

    def test_load_rbspice_esrhelt_suffix_none(self):
        del_data('*')
        rbspice_vars = pyspedas.rbsp.rbspice(trange=['2013-11-5', '2013-11-6'], datatype='ESRHELT', level='l3', suffix=None)
        self.assertTrue(data_exists('rbspa_rbspice_l3_ESRHELT_FEDU'))

    def test_load_rbspice_esrhelt_prefix_suffix(self):
        del_data('*')
        rbspice_vars = pyspedas.rbsp.rbspice(trange=['2013-11-5', '2013-11-6'], datatype='ESRHELT', level='l3', prefix='pre_', suffix='_suf')
