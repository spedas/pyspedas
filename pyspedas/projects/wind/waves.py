...
def waves(trange=['2018-11-5', '2018-11-6'],
    ...
    >>> vars = pyspedas.projects.wind.waves(trange=['2018-11-5', '2018-11-6'],datatype='h1')
    >>> tplot(vars)

    """
    return load(instrument='waves', trange=trange, datatype=datatype, prefix=prefix, suffix=suffix, get_support_data=get_support_data, varformat=varformat, varnames=varnames, downloadonly=downloadonly, force_download=force_download, notplot=notplot, time_clip=time_clip, no_update=no_update, addmaster=addmaster)
