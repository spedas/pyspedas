...
def het(trange=['2013-11-5', '2013-11-6'],
    ...
    ----------
        ...
        >>> sit_vars = pyspedas.projects.stereo.het(trange=['2013-1-5', '2013-1-6'])
        >>> tplot(sit_vars)

    """

    return load(instrument='het', trange=trange, probe=probe, suffix=suffix, prefix=prefix, level=level,
