...
def magn(trange=['2013-01-29','2013-01-30'],
    ...
    ----------
        ...
        >>> tplot('brl1A_Total')
    """
    return load(datatype='magn', trange=trange, probe=probe,  prefix=prefix, suffix=suffix, downloadonly=downloadonly, time_clip=time_clip, no_update=no_update, force_download=force_download)
