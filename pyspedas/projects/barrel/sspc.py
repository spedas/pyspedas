...
def sspc(trange=['2013-01-28', '2013-01-29'],
    ...
    """
    return load(datatype='sspc', trange=trange, probe=probe,  prefix=prefix, suffix=suffix, downloadonly=downloadonly, time_clip=time_clip, no_update=no_update, force_download=force_download)
