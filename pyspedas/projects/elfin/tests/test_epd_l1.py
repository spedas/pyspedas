...
class TestELFL1Validation(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.elf_pef_raw = pyspedas.pytplot.get_data(f"el{cls.probe}_pef_raw")
        ...
        filename = CONFIG['local_data_dir'] + calfile_name
        tplot_restore(filename)
        cls.elf_pef_cps = pyspedas.pytplot.get_data(f"el{cls.probe}_pef_cps")
        ...
        filename = CONFIG['local_data_dir'] + calfile_name
        tplot_restore(filename)
        cls.elf_pef_nflux = pyspedas.pytplot.get_data(f"el{cls.probe}_pef_nflux")
        ...
        filename = CONFIG['local_data_dir'] + calfile_name
        tplot_restore(filename)
        cls.elf_pef_eflux = pyspedas.pytplot.get_data(f"el{cls.probe}_pef_eflux")
        cls.elf_pef_sectnum = pyspedas.pytplot.get_data(f"el{cls.probe}_pef_sectnum")
        cls.elf_pef_nspinsinsum = pyspedas.pytplot.get_data(f"el{cls.probe}_pef_nspinsinsum")
        cls.elf_pef_nsectors = pyspedas.pytplot.get_data(f"el{cls.probe}_pef_nsectors")
        cls.elf_pef_spinper = pyspedas.pytplot.get_data(f"el{cls.probe}_pef_spinper")
    ...
    def test_epd_l1_raw(self):
        ...
        elf_pef_raw = pyspedas.pytplot.get_data(f"el{self.probe}_pef_raw")
    ...
    def test_epd_l1_cps(self):
        ...
        elf_pef_cps = pyspedas.pytplot.get_data(f"el{self.probe}_pef_cps")
    ...
    def test_epd_l1_nflux(self):
        ...
        elf_pef_nflux = pyspedas.pytplot.get_data(f"el{self.probe}_pef_nflux")
    ...
    def test_epd_l1_eflux(self):
        ...
        elf_pef_eflux = pyspedas.pytplot.get_data(f"el{self.probe}_pef_eflux")
        elf_pef_sectnum = pyspedas.pytplot.get_data(f"el{self.probe}_pef_sectnum")
        elf_pef_nspinsinsum = pyspedas.pytplot.get_data(f"el{self.probe}_pef_nspinsinsum")
        elf_pef_nsectors = pyspedas.pytplot.get_data(f"el{self.probe}_pef_nsectors")
        elf_pef_spinper = pyspedas.pytplot.get_data(f"el{self.probe}_pef_spinper")
