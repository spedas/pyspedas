...
class LoadTestCases(unittest.TestCase):
    ...
    def test_load_isee_fluxgate_data(self):
        del_data()
        fg_vars = pyspedas.erg.gmag_isee_fluxgate(trange=['2020-08-01/00:00:00','2020-08-01/02:00:00'], site='lcl')
    ...
    def test_load_stel_fluxgate_data(self):
        del_data()
        fg_vars = pyspedas.erg.gmag_stel_fluxgate(trange=['2020-08-01/00:00:00','2020-08-01/02:00:00'], site='lcl')
        self.assertTrue(data_exists('isee_fluxgate_mag_lcl_64hz_hdz'))
        self.assertTrue('isee_fluxgate_mag_lcl_64hz_hdz' in fg_vars)
    ...
    def test_load_stel_induction_data(self):
        del_data()
        ind_vars = pyspedas.erg.gmag_stel_induction(trange=['2020-08-01/00:00:00', '2020-08-01/02:00:00'], site='msr')
        self.assertTrue(data_exists('isee_induction_db_dt_msr'))
        self.assertTrue('isee_induction_db_dt_msr' in ind_vars)

    def test_load_magdas_1sec_data(self):
        del_data()
        magdas_vars = pyspedas.erg.gmag_magdas_1sec(trange=["2010-01-01/00:00:00", "2010-01-01:02:00:00"], site='ama')
