...
class LoadTestCases(unittest.TestCase):
    ...
    def test_mepi_theta(self):
        ...
        pyspedas.projects.erg.mepi_nml( trange=[ '2017-04-05 21:45:00', '2017-04-05 23:59:59'], datatype='3dflux' )
    ...
    def test_mepi_en_pad_limit(self):
        ...
        pyspedas.pytplot.options('erg_mepi_l2_3dflux_FPDU_energy_mag_pa80-100', 'ytitle', 'MEP-i flux\nPA: 80-100\n\n[eV]')
        pyspedas.pytplot.options('erg_mepi_l2_3dflux_FPDU_energy_mag_pa0-10', 'ytitle', 'MEP-i flux\nPA: 0-10\n\n[eV]')
