...
import os
import unittest
from pyspedas import data_exists, del_data, timespan,tplot, tplot_names
...
class LoadTestCases(unittest.TestCase):
    ...
    def test_xep_en_pad_limit(self):
        ...
        pyspedas.pytplot.options('erg_xep_l2_FEDU_SSD_energy_mag_pa80-100', 'ytitle', 'XEP-e flux\nPA: 80-100\n\n[eV]')
        pyspedas.pytplot.options('erg_xep_l2_FEDU_SSD_energy_mag_pa0-10', 'ytitle', 'XEP-e flux\nPA: 0-10\n\n[eV]')
