...
def cis(trange:List[str]=['2018-11-5', '2018-11-6'],
    ...
    option: str
        The data option to load. Default: 'mom  Valid options::

            'mom' (moments)
            'psd_h1' (H+ codif PSD)
            'psd_he1' (He+ codif PSD)
            'psd_o1' (O+ codif PSD)
            'psd_ions' (ion hia PSD)
            'def_h1' (H+ codif differential energy flux)
            'def_he1' (He+ codif differential energy flux)
            'def_o1' (O+ codif differential energy flux)
